...
# 🧠 Mohit Varma Sagi – Data Science, Machine Learning, and Deep Learning Portfolio

Welcome to my project portfolio!  
This repository brings together my work in Data Science, Machine Learning, Deep Learning, Exploratory Data Analysis (EDA), and Business Intelligence. It highlights a wide range of real-world projects that reflect both technical proficiency and practical problem-solving skills.
...
- **Data_Science_Salary-EDA.ipynb**: Analyzing global data science salaries and skill trends.
- **Heart_Attack_Analysis.ipynb**: Exploring heart disease risk factors.
- **Movie Portfolio Project.ipynb**: Visualizing movie performance and audience trends.
- **Diabetes Prediction With Python.ipynb**: Understanding correlations in diabetes-related factors.

### 📊 SQL Projects & Data Cleaning
- **COVID Portfolio Project - Data Exploration.sql**: Deep SQL-driven insights into COVID-19 global impact.
- **Data Cleaning Portfolio Project Queries.sql**: Real-world SQL queries for preparing clean, analysis-ready datasets.
- **Nashville Housing Data Cleaning.xlsx**: Real-estate data cleaning and feature engineering.

### 🤖 Machine Learning Projects
- **Car_recommender.ipynb**: A recommendation system for cars based on feature similarity.
- **Diabetes Prediction With Python.ipynb**: Classification model to predict diabetes risk using machine learning algorithms.

---

## 🤖 Deep Learning Projects
- **Gender Detection Model** (EduMentor Project):  
  Built a deep learning model to predict gender from facial images using Convolutional Neural Networks (CNN).

- **Mask Detector Model** (EduMentor Project):  
